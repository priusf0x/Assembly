...
enum  compiler_commands_e
{
    ...
    COMPILER_COMMAND_INCORRECT_COMMAND = 9,
    COMPILER_COMMAND_VALID_SYNTAX      = 10,
    COMPILER_COMMAND_INVALID_SYNTAX    = 11,
    COMPILER_COMMAND_EMPTY_COMMAND     = 12
};
...
const struct command_t COMMANDS_ARRAY[] = {
    ...
    {.command_name = "POP",   .return_value = COMPILER_COMMAND_POP,              .handler = ReadPopArgument },
